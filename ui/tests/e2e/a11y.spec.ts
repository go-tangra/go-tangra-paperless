...
// T070 / SC-006: every paperless view inside the shell, both themes, zero serious or
...
const routes = ['/paperless',  '/paperless/categories',  '/paperless/search',  '/paperless/dashboard']

test.describe('paperless accessibility', () => {
