// Standalone development entry: mounts the paperless routes in a bare kit shell
...
const app = createApp({ render: () => h(UiAppShell, { title: 'paperless (dev)', hideNav: true }, () => h(RouterView)) })
app.use(createPinia())
