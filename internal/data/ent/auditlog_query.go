...
func (_q *AuditLogQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *AuditLogQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *AuditLogQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *AuditLogQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *AuditLogQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *AuditLogQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(auditlog.FieldCreateTime).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.AuditLog.Query().
//		Select(auditlog.FieldCreateTime).
//		Scan(ctx, &v)
...
func (_q *AuditLogQuery) prepareQuery(ctx context.Context) error {
	...
	if err := auditlog.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *AuditLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(auditlog.Table, auditlog.Columns, sqlgraph.NewFieldSpec(auditlog.FieldID, field.TypeUint32))
	_spec.From = _q.sql
