// Package httpapi is the gateway-facing HTTP API of the lcm module: every
...
import (
	...
	"github.com/go-freya/freya/services/paperless/api/openapi"
...
func LoadDocument() (*openapi3.T, error) {
	...
	doc, err := loader.LoadFromData(openapi.Paperless)
	if err != nil {
